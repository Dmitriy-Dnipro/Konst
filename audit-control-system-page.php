<?php
/**
* Template Name: Шаблон страницы Система управления компрессорами Аудит
...
?>
<div id="primary" class="content-area audit-control-system-page"> 
	<div class="main-wrapper">
		...
		<main class="content" id="audit-page">	
			...
			<?php $media_content = get_field('media_content');  ?>
					...
					<div class="row">
						<div class="offset-md-4 col-lg-8 col-12">
							<div class="row media-content">
								<div class="col-lg-7">
									<a href="#" data-toggle="modal" data-target="#imageModalSecond"><?= (!empty($media_content['img_link_title'])) ? $media_content['img_link_title'] : ''; ?></a>
								</div>
								<div class="col-lg-5">
									<?php if (!empty($media_content['file'])) {?>
										<div class="file">
											<a class="main-form__inp-submit main-form__inp-submit_p file_button" href="<?= $media_content['file']['link']; ?>" target="_blank">
												<span><?= $media_content['button_title']; ?></span> 
												<span>
											...
											<span><?= $media_content['file']['title']; ?></span>
										</div>
									<?php } ?>
								</div>
							</div>
			...
			<section class="about-block second main-bg-top" id="services-tabs-block">

				<div class="container">
					<?php include'template-parts/two_vertical-block-with-text-block.php' ?>
				</div>
			</section>
...
get_footer();
?>
<?php if (!empty($media_content['image']['url'])) { ?>
	<div class="consult-modal modal animated fadeInDown" id="imageModalSecond" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"> 
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<img src="<?= $media_content['image']['url']; ?>" alt="<?= $media_content['image']['alt']; ?>" style="width: 100%;">					
				</div>
			</div>
		</div>
	</div>
