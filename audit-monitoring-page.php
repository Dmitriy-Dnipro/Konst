<?php
/**
* Template Name: Шаблон страницы Мониторинг потребителей и производства сжатого воздуха
...
?>
<div id="primary" class="content-area audit-monitoring-page">
	<div class="main-wrapper">

		<!-- BEGIN CONTENT -->

		<main class="content" id="audit-monitoring-page">	
			...
			<!-- Text block-->
			<section class="about-block text" id="text-block">
				<div class="container">
			...
			<!-- Tabs block -->
			<section class="services-tabs-block main-bg" id="services-tabs-block">
