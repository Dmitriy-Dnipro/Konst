...
$about_us_block = get_field('about_work_gallary');
?>
<?php if ( !empty($about_us_block['title']) || !empty($about_us_block['description']) || !empty($about_us_block['text']) || !empty ($image_slider) ) { ?>
	...
	<div class="row align-items-center">
		...
		<div class="text-block col-xl-8 col-lg-8 col-md-8 col-12">
			...
			<div id="horizontal-focus-center-element-slider">

				<?php if (!empty ($about_us_block)) { ?>
					<?php foreach ($about_us_block['image'] as $image) { ?>
						<div class="slide">
